    ...
    if (!sessionValid) {
      ...
      await tryMethods([
        async () => {
          ...
          await sleep(1000);
          await page.type('#login_loginid_input_01', DOKKI_USERNAME, { delay: randomDelay(80, 150) });
          await sleep(1000);
        ...
        async () => {
          ...
          await el.click();
          await sleep(1000);
          await el.type(DOKKI_USERNAME, { delay: randomDelay(80, 150) });
          await sleep(1000);
      ...
      await tryMethods([
        async () => {
          ...
          await sleep(1000);
          await page.type('#login_password_input_01', DOKKI_PASSWORD, { delay: randomDelay(80, 150) });
          await sleep(1000);
          console.log('    focus + type');
        },
        async () => {
          ...
          await el.click();
          await sleep(1000);
          await el.type(DOKKI_PASSWORD, { delay: randomDelay(80, 150) });
          await sleep(1000);
          console.log('    $ find + click + type');
        }
      ], 'PASSWORD', 15000);
